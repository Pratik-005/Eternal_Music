...
class loginform:
    ...
    def __init__(self, window):
        ...
        self.sign_in_label = Label(self.lgn_frame, text='sign in', fg='white', font=('yu gothic ui', 25, 'bold'),
                                   bg='#040405')
        self.sign_in_label.place(x=707, y=98)

        self.username_label = Label(self.lgn_frame, text='Username', bg='#040405', font=('yu gothic ui', 17, 'bold'),
                                    fg='white')
        self.username_label.place(x=576, y=259)
        global Username_entry
        self.Username_entry = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg='#33362e', fg="#6b6a69",
        ...
        self.password_label = Label(self.lgn_frame, text='Password', bg='#040405', font=('yu gothic ui', 17, 'bold'),
                                    fg='white')
        self.password_label.place(x=576, y=362)
        global password_entry
        self.password_entry = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg='#33362e', fg="#6b6a69",
                                    font=('yu gothic ui', 12, 'bold'))
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN', font=('yu gothic vi', 13, 'bold'), width=15, bd=0,
                            bg='#6f99f2', cursor='hand2', activebackground='#2f6aeb', fg='white', command=self.check)
        ...
        # user_data = {"Pratik":"pass@pratik","kiran":"pass@abc","harsh":"pass@xyz"}
    ...
    def main_win3():
        ...
        loadbtn = Button(root, text="Load Music", bg="#4539ed", padx=8, pady=4, fg="white", font="Helvetica 13 bold",
                         bd=0, command=add_song)
    ...
    def check() :
        if username == "Pratik" and password == "pass@pratik" :
            self.main_win3()
        elif username == "kiran" and password == "pass@pratik":
            self.main_win3()  
    ...
    """def check():
        ...
        for i in range(len(user_data)):
            if username == list1[i] and password == list2[i]:
                var = True
                self.main_win3()

        if var is False:
            msg.showinfo("Alert", "Username or Password is invalid")"""
    ...
    def drag_motion(event):
        ...
        # self.lgn_frame.bind("<Button-1>", drag_start)
        # self.lgn_frame.bind("<B1-Motion>", drag_motion)
